...
export default function CoordinatorManualApprove() {
    ...
    <div className="flex min-h-screen bg-[#f4f6fb]" style={{ fontFamily:"'Figtree','Segoe UI',sans-serif" }}>
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 flex flex-col bg-[#0f2744] transition-all duration-300 overflow-hidden flex-shrink-0 ${sidebarOpen ? "w-64" : "w-0 md:w-64"}`}>
        <div className="flex items-center gap-3 px-5 py-5 border-b border-white/10">
          <div className="w-9 h-9 rounded-xl bg-teal-500/20 border border-teal-400/30 flex items-center justify-center flex-shrink-0">
        ...
        <main className="flex-1 p-5 md:p-8">
          <div className="w-full max-w-2xl mx-auto mt-4 md:mt-10">
            <div className="bg-white rounded-3xl border border-slate-100 shadow-xl overflow-hidden">
              <div className="p-8 md:p-10 text-center relative overflow-hidden" style={{ background: "linear-gradient(135deg, #f0fdfa, #ffffff)" }}>
                <div className="w-16 h-16 bg-teal-100 rounded-2xl mx-auto flex items-center justify-center mb-5 border border-teal-200">
                  <FileCheck2 size={32} className="text-teal-600" />
                </div>
              ...
              <div className="p-8 md:p-10 border-t border-slate-100 bg-white">
                ...
                >
                  <div className="flex flex-col items-center justify-center pt-5 pb-6">
                    {selectedFile ? (
                      <>
                        <FilePlus2 className="w-10 h-10 mb-3 text-teal-500" />
                        <p className="mb-2 text-sm font-semibold text-teal-700">{selectedFile.name}</p>
                        <p className="text-xs text-teal-600/70">{(selectedFile.size / 1024 / 1024).toFixed(2)} MB</p>
                      </>
                    ) : (
                      <>
                        <Upload className="w-10 h-10 mb-3 text-slate-400" />
                        <p className="mb-2 text-sm font-semibold text-slate-600"><span className="text-teal-600 font-bold">Click to upload</span> or drag and drop</p>
